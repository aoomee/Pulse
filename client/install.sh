...
# Usage: curl -sSL https://github.com/aoomee/Pulse/releases/download/v1.4.0-vnstat.11/install.sh | sudo bash -s -- --id YOUR_ID --server http://YOUR_SERVER:8080
#
...
GITHUB_REPO="https://github.com/aoomee/Pulse/releases/download/v1.4.0-vnstat.11"
CLIENT_PORT="9090"
AGENT_NAME=""
SECRET=""
AUTO_UPDATE=true
...
show_help() {
    ...
    echo ""
    echo "Or using curl:"
    echo "  curl -sSL https://github.com/aoomee/Pulse/releases/download/v1.4.0-vnstat.11/install.sh | sudo bash -s -- --id my-server-1 --server http://monitor.example.com:8080 --secret my-secret"
}
